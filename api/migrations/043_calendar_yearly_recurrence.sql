-- Ergänzt "jährlich" als Wiederholungs-Option (z.B. für Geburtstage im
-- Straßenkalender). SQLite kann CHECK-Constraints nicht per ALTER TABLE
-- ändern, daher Tabelle neu aufbauen wie in Migration 032/041.
